    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-secondary-text">
          Your real-time performance statistics
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="bg-elevated-bg border-input-border">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-[#FFFDD0]">
              {mockStats.totalLeadsAssigned}
            </div>
        ...
        <Card className="bg-elevated-bg border-input-border">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CheckCircle className="h-4 w-4 text-cream-primary" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[#FFFDD0]">
              {mockStats.leadsMarkedAsSold}
            </div>
        ...
        <Card className="bg-elevated-bg border-input-border">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <RotateCcw className="h-4 w-4 text-cream-primary" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[#FFFDD0]">
              {mockStats.pendingReplacements}
            </div>
        ...
        <Card className="bg-elevated-bg border-input-border">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <DollarSign className="h-4 w-4 text-cream-primary" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[#FFFDD0]">
              ${mockStats.annualSubmitTotal.toLocaleString()}
            </div>
        ...
        <CardContent>
          <div className="space-y-4">
            {mockStats.topPerformingStates.map((state, index) => (
              <div
                key={state.state}
                className="flex items-center justify-between p-4 rounded-lg bg-section-bg border border-input-border"
              >
