    ...
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <Card className="bg-black/40 border border-gray-700">
          <CardHeader>
            <CardTitle className="text-lg font-bold text-cream-primary">
              Current Plan
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              <Badge className="bg-gray-700/20 text-cream-primary border-gray-400/50 text-lg px-3 py-1">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-white">
                    {subscriptionData.currentWeek} of{" "}
                    {subscriptionData.totalWeeks}
                  </span>
                </div>
                <div className="w-full bg-gray-700 rounded-full h-2">
                  <div
                    className="bg-gradient-to-r from-gray-500 to-cream-primary h-2 rounded-full"
                    style={{
                      width: `${
                        (subscriptionData.currentWeek /
                          subscriptionData.totalWeeks) *
                        100
                      }%`,
                    }}
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <Calendar className="h-4 w-4 text-cream-primary" />
                <span className="text-white">
                  {subscriptionData.nextBillingDate}
                </span>
              </div>
              <div className="flex items-center space-x-2">
                <CreditCard className="h-4 w-4 text-cream-primary" />
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex justify-between text-sm">
                ...
                <span className="text-white">
                  {subscriptionData.leadsReceived} /{" "}
                  {subscriptionData.totalLeadsInPlan}
                </span>
              </div>
              <div className="w-full bg-gray-700 rounded-full h-2">
                <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="p-4 rounded-lg bg-gray-800/30 border border-gray-700/50">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <span className="text-sm text-gray-100/70">Total Leads</span>
              </div>
            ...
            <div className="p-4 rounded-lg bg-gray-800/30 border border-gray-700/50">
              <div className="flex items-center space-x-2 mb-2">
                <TrendingUp className="h-4 w-4 text-cream-primary" />
                <span className="text-sm text-gray-100/70">Usage Rate</span>
              </div>
              <div className="text-2xl font-bold text-cream-primary">
            ...
            <div className="p-4 rounded-lg bg-gray-800/30 border border-gray-700/50">
              <div className="flex items-center space-x-2 mb-2">
                <CreditCard className="h-4 w-4 text-cream-primary" />
                <span className="text-sm text-gray-100/70">Monthly Spend</span>
              </div>
              <div className="text-2xl font-bold text-cream-primary">
                ${subscriptionData.nextBillingAmount}
              </div>
            ...
            <div className="p-4 rounded-lg bg-gray-800/30 border border-gray-700/50">
              <div className="flex items-center space-x-2 mb-2">
                <Calendar className="h-4 w-4 text-cream-primary" />
                <span className="text-sm text-gray-100/70">Days Left</span>
              </div>
              <div className="text-2xl font-bold text-cream-primary">12</div>
            </div>
          </div>
        </CardContent>
      </Card>
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-gray-800/30 border-gray-700/50">
                  ...
                  <TableHead className="text-cream-primary">Amount</TableHead>
                  <TableHead className="text-cream-primary">Status</TableHead>
                  <TableHead className="text-cream-primary">Action</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {receiptHistory.map((receipt) => (
                  <TableRow
                    key={receipt.id}
                    className="border-gray-700/50 hover:bg-gray-800/20"
                  >
                    ...
                    <TableCell>
                      <Button
                        size="sm"
                        variant="outline"
                        className="border-gray-400/50 text-cream-primary hover:bg-cyan-500/20"
                      >
